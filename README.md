...
### Software Developer | 4 Years of Experience | React.js • Next.js • TypeScript • Node.js • Express.js (Fullstack JavaScript)
...
- **Delivered web solutions across 12 production web applications** including customer-facing platforms, internal business systems, and administrative dashboards for an enterprise internet service provider.
...
- **Delivered web solutions across 6 production web applications** in the education, healthcare, media, and recruitment industries.
...
- **Delivered web solutions for 2 no-code application platforms**, enabling startups, enterprises, and government organizations to build visual applications.
...
React.js, Next.js, JavaScript (ES5, ES6+), TypeScript, HTML, CSS, Tailwind CSS, Shadcn UI, Material UI, Ant Design, Chakra UI, Bootstrap, LESS, Framer Motion, SSR, SSG

### Frontend Ecosystem

REST, GraphQL, Axios, TanStack Query, Apollo Client, Zustand, Redux, React Router, TanStack Router, React Hook Form, Zod, TanStack Table, React DND Kit, React Draggables, Storybook

### Backend

Node.js, Express.js, Prisma, PostgreSQL, Supabase, Strapi CMS, Websocket, MongoDB
...
Antigravity, Cursor, V0, Lovable, Stitch, Figma Make, Claude, ChatGPT, n8n
